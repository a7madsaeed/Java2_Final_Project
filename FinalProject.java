...
public class FinalProject {
    ...
    public static void main(String[] args) {
        ...
        exam.add(new Exam("math", 5, 4, true, true, true, q, (Teacher) users.get(1)));
        exam.add(new Exam("english", 4, 2, true, false, true, q, (Teacher) users.get(2)));
        exam.add(new Exam("physic", 2, 2, true, true, false, q, (Teacher) users.get(1)));
        exam.add(new Exam("oop", 3, 2, true, true, false, q, (Teacher) users.get(1)));
